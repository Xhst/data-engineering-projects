...
def extract_caption(table_container: html.HtmlElement, table_id: str) -> str:
    ...
    caption_fragments = table_container.xpath('.//*[contains(@class, "ltx_caption")]//text()')
    # If we did not found any caption, we try a stricter rules
    if caption_fragments == []:
        caption_fragments = table_container.xpath(f'./p[contains(@id, "{table_id}.")]//text()')
    if caption_fragments == []:
        caption_fragments = table_container.xpath(f'./span[contains(@id, "{table_id}.")]//text()')
